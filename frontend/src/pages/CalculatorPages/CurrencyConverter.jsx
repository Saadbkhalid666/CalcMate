...
export const CurrencyConverter = () => {
  ...
  if (error) {
    return (
      <div className="min-h-[calc(100vh-64px)] flex justify-center items-center px-4 bg-gray-100">
  ...
  if (!currencyList || Object.keys(currencyList).length === 0) {
    return (
      <div className="min-h-[calc(100vh-64px)] flex justify-center items-center px-4 bg-gray-100">
        <p className="text-gray-600">Loading currency list...</p>
      </div>
    );
  }
  ...
  // Main UI
  return (
    <div className="min-h-[calc(100vh-200px)] flex justify-center items-center px-4 bg-gray-100">
