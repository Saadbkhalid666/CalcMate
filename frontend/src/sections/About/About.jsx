...
export const About = () => {
  return (
    <section id="aboutus" className="mt-[10%] px-4">
      <h1
        className="text-5xl text-[#3190ce] text-center font-extrabold font-sans mb-[5%]"
        data-aos="fade"
        data-delay-aos={100}
      >
        About Us
      ...
      <div className="container mx-auto flex flex-col items-center">
        {/* Image only shown on large screens */}
        <div
        ...
        >
          <p className="text-xl leading-relaxed">
            ...
            and intuitive <strong className="text-[#3190ce]">calculator app</strong> developed to{" "}
            ...
            and <strong className="text-[#3190ce]">unit converter</strong>. Whether
            it's for personal finance, academic use, health tracking, or
            professional calculations, CalcMate ensures that every user has
            access to a seamless and efficient experience.
            <br />
            <br />
            This app is proudly a product of{" "}
